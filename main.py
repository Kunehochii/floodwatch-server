...
def setup_buzzer():
    ...
    try:
        ...
        GPIO.output(BUZZER_PIN, GPIO.HIGH)  # OFF with pull-up resistor
    ...
    try:
        while buzzer_running:
            ...
            if interval is None:
                ...
                # Beep pattern: LOW to beep for 100ms, HIGH for silence
                GPIO.output(BUZZER_PIN, GPIO.LOW)  # ON (beep)
                time.sleep(0.1)  # Beep duration
                GPIO.output(BUZZER_PIN, GPIO.HIGH)  # OFF (silence)
